...
I added the following benchmarks to contribute to Issue [#9711](https://github.com/pydantic/pydantic/issues/9711):
...
1. [PR #10271: Add benchmarks for schema generation with custom validators](https://github.com/pydantic/pydantic/pull/10271)
1. [PR #10290: Add schema generation benchmarks for models with custom serializers](https://github.com/pydantic/pydantic/pull/10290)
1. [PR #10362: benchmark tagged/untagged unions and stdlib types in schema generation](https://github.com/pydantic/pydantic/pull/10362)
1. [PR #10568: Add benchmarks for schema generation with pydantic custom types](https://github.com/pydantic/pydantic/pull/10568)
1. [PR #10602: Add benchmarks for schema generation with recursive models](https://github.com/pydantic/pydantic/pull/10602)
