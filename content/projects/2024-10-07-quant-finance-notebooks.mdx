...
1. [Ordinary Least Squares](https://github.com/AdolfoVillalobos/quant-finance-notebooks/blob/main/notebooks/07-ordinary-least-squares.ipynb)
1. [Multivariate Least Squares](https://github.com/AdolfoVillalobos/quant-finance-notebooks/blob/main/notebooks/08-multivariate-least-squares.ipynb)
1. [Regression Tests](https://github.com/AdolfoVillalobos/quant-finance-notebooks/blob/main/notebooks/09-regression-tests.ipynb)
1. [Multicolinearity](https://github.com/AdolfoVillalobos/quant-finance-notebooks/blob/main/notebooks/10-multicolinearity.ipynb)
